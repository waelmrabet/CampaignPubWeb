...
@Component({
  selector: 'app-select-compos-example',
  templateUrl: './select-compos-example.component.html',
  styleUrls: ['./select-compos-example.component.scss']
})
export class SelectComposExampleComponent implements OnInit {
